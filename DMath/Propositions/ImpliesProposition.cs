...
namespace DMath.Propositions
{
    ...
    {
        public ImpliesProposition(BaseProposition leftProposition, BaseProposition rightProposition) : base(
        ...
        {
            return RightProposition.CalculateValue() ||
                   LeftProposition.CalculateValue() == RightProposition.CalculateValue();
        }
